...
return [
    ...
    */
    ...
    'scripts' => [
        ...
        'vendor/laravel-grapesjs/assets/editor.min.js',
    ...
    */
    ...
    'canvas' => [
        'styles' => [
            ...
            'css/utility.css',
            'css/colors.php?color=0087cb',
            'css/pages/oferta-casa-verde-2023.css',
        ],
        'scripts' => [
            'js/jquery.js',
            'js/plugins.min.js',
    ...
    */
    ...
    'assets' => [
        'disk' => 'server_public', //Default: local
    ...
    */
    ...
    'plugins' => [
        ...
        'custom' => [
            ...
            [
                'enabled' => false,
                'name' => 'grapesjs-default-panels',
                'options' => ['panel' => 'tablet'],
                'scripts' => [
                    env('APP_URL').'/vendor/laravel-grapesjs/assets/plugins/default-panels/tablet-panel.js',
                ],
            ],
        ],
    ],
